...
date: Last modified on January 7, 2017
output: 
  html_document:
    theme: spacelab
    code_folding: show
...
You will see a `+` in console calling for input, which means you have put in an incomplete command and R is waiting for you to finish. To leave the prompt, press ESCAPE on your 
```{r, eval=FALSE}
